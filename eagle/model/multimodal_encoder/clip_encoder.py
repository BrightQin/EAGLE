...
class LanguageBindVideoTower(nn.Module):
    ...
    @property
    def dtype(self):
        return self.LanguageBindVideo.dtype

    @property
    def device(self):
        return self.LanguageBindVideo.device
...
class LanguageBindAudioTower(nn.Module):
    ...
    def load_model(self, device_map=None):
        ...
        self.LanguageBindAudio = LanguageBindAudio.from_pretrained(self.vision_tower_name, device_map=device_map)
        tokenizer = LanguageBindAudioTokenizer.from_pretrained(self.vision_tower_name)
        self.image_processor = LanguageBindAudioProcessor(self.LanguageBindAudio, tokenizer)
        self.vision_tower = self.LanguageBindAudio.vision_model
        self.vision_tower.requires_grad_(False)
    ...
    @property
    def dtype(self):
        return self.LanguageBindAudio.dtype

    @property
    def device(self):
        return self.LanguageBindAudio.device
