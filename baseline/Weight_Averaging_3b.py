...
#     output_paths=["checkpoints/Baseline/Images/finetune/pr_llm/finetune-eagle-x1-llama3.2-3b-image_L/weight_averaging_image_video", 
#                   "checkpoints/Baseline/Video/finetune/pr_llm/finetune-video-llama3.2-3b/weight_averaging_image_video"],
#     weights=[0.0, 0.5, 0.5],  # 可选：指定每个模型的权重，包括基础模型
#     remove_keys=[]
# )
...
weight_averaging(
    ...
    output_paths=["checkpoints/Baseline/Images/finetune/pr_llm/finetune-eagle-x1-llama3.2-3b-image_L/weight_averaging_image_video_audio", 
                  "checkpoints/Baseline/Video/finetune/pr_llm/finetune-video-llama3.2-3b/weight_averaging_image_video_audio",
                  "checkpoints/Baseline/Audio/finetune/pr_llm/finetune-audio-llama3.2-3b/weight_averaging_image_video_audio"],
