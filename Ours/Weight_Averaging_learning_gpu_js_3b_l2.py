...
def optimize_task_vectors_entropy(task_vectors, learning_rate=5e-5, max_iterations=50, temperature=2e-4, eps=1e-8, alpha=0.5):
    ...
    for iteration in range(max_iterations):
        ...
        if (iteration + 1) % 1 == 0:
            ...
            print(f"迭代 {iteration + 1}/{max_iterations}, 总损失: {current_loss:.6f}, JS损失: {js_loss_val:.6f}, 元素L2损失: {mag_loss_val:.6f}, MTL平均幅度: {mtl_mean_mag:.6f}")
...
tall_tier_merging(
    ...
    output_paths=["checkpoints/Baseline/Images/finetune/pr_llm/finetune-eagle-x1-llama3.2-3b-image_L/weight_averaging_image_video_audio_increamental_js", 
                  "checkpoints/Incremental/Video/finetune-eagle-x1-llama3.2-3b-image_L/finetune/pr_llm/finetune-video-llama3.2-3b/weight_averaging_image_video_audio_increamental_js",
                  "checkpoints/Incremental/Audio/finetune-video-llama3.2-3b/finetune/pr_llm/finetune-audio-llama3.2-3b/weight_averaging_image_video_audio_increamental_js"],
    lambda_scale=1.0,
    remove_keys=[]
)
...
#     tuned_paths=["checkpoints/Baseline/Images/finetune/pr_llm/finetune-eagle-x1-llama3.2-3b-image_L", 
#                  "checkpoints/Incremental/Video/finetune-eagle-x1-llama3.2-3b-image_L/finetune/pr_llm/finetune-video-llama3.2-3b"],
#     output_paths=["checkpoints/Baseline/Images/finetune/pr_llm/finetune-eagle-x1-llama3.2-3b-image_L/weight_averaging_image_video_increamental_js", 
#                   "checkpoints/Incremental/Video/finetune-eagle-x1-llama3.2-3b-image_L/finetune/pr_llm/finetune-video-llama3.2-3b/weight_averaging_image_video_increamental_js",
#                   ],
#     lambda_scale=1.0,
#     remove_keys=[]
# )