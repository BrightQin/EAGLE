...
def eval_model(args):
    ...
    question_answer = json.load(open(os.path.expanduser(args.question_file), "r"))
    question_answer = get_chunk(question_answer, args.num_chunks, args.chunk_idx)
    answers_file = os.path.expanduser(args.answers_file)
    os.makedirs(os.path.dirname(answers_file), exist_ok=True)
    ans_file = open(answers_file, "w")
    for i, line in enumerate(tqdm(question_answer)):
        idx = line["id"]
